...
<th><input  id="price" type="text" name="price"></th>
<td><span id="eprice" style="color:red" ></span></td>
</tr>
<th>Enter Book Author</th>
<th><input id="author" type="text" name="author"></th>
...
<th><input id="quantity" type="text" name="quantity"></th>
<td><span id="ebookquantity" style="color:red" ></span></td>
</tr>
<tr>
<th>Enter Book Image</th>
