...
public class CartDaoImpl implements CartDao
{
	...
	public boolean addToCart(Cart c)
	{
		...
		try 
			...
			String sql="insert into Cart(bookId,quantity,emailId)values(?,?,?)";
	...
	public List<Cart> showCart(String emailId) 
	{
		...
		try 
		{
			...
			String sql="select b.bookId,b.bookName,b.price,c.cartId,c.quantity from Book_22265 as b inner join Cart as c on b.bookId=c.bookId and c.emailId=?";
			...
			while(rs.next())
			{
				...
				c.setBookQuantity(rs.getInt("quantity"));
				cartList.add(c);
			}
			return cartList;
		} 
