...
public class CustomerTest {
	...
	public static void main(String[] args) 
	{
		...
		while(true)
		{
			...
			System.out.println("4.GetAllCustomer");
			...
			case 2:
				...
				System.out.println("Enter Customer2 id to update:");
			...
			case 3:
				...
				break;
			case 4:
				List<Customer>al=customerdao.getAllCustomer();
			...
			case 5:
				...
				customerId=sc.nextInt();
			    Customer customer1=customerdao.searchById(customerId);
			    System.out.println(customer1);
			     
			  break;   
			case 6:
				System.out.println("Enter customer email id to be search");
				emailId=sc.next();
			    Customer customer2=customerdao.searchByCustomerEmailId(emailId);
